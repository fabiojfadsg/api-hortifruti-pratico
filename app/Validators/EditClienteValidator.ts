...
export default class EditClienteValidator {
  ...
  public schema = schema.create({ 
    ...
    email: schema.string({ trim: true }, [
      rules.email(),
      rules.maxLength(255),
      rules.unique({ table: 'users', column: 'email', whereNot: this.refs.userId }),
    ]),
  ...
  public messages: CustomMessages = {
    ...
    'nome.minLength': '{{ field }} deve ter no mínimo 3 caracteres',
    'nome.maxLength': '{{ field }} deve ter no máximo 255 caracteres',
